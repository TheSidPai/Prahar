...
android {
    ...
    // AGP resolves an NDK during configuration whether or not this line is
    // present — removing it and setting android.builder.sdkDownload=false were
    // both tried, and the build failed identically both times. So the NDK is
    // simply installed (tools\dev.ps1 sdkpkg "ndk;<version>"), and this stays
    // at the Flutter default for version consistency.
    ...
    compileOptions {
        ...
        // that are not available on older Android API levels. Without this the
        // build fails with an opaque error about missing java.time classes.
        isCoreLibraryDesugaringEnabled = true
    }

    defaultConfig {
        // TODO: Specify your own unique Application ID (https://developer.android.com/studio/build/application-id.html).
        applicationId = "com.siddhantpai.prahar"
