...
void main() {
  ...
  group('examHasPassed', () {
    test('is false on the day of the exam, however late', () {
      expect(exam(date: today).examHasPassed(DateTime(2026, 9, 4, 23)), isFalse);
      expect(exam(date: today, minute: 9 * 60)
          .examHasPassed(DateTime(2026, 9, 4, 23)), isFalse,
